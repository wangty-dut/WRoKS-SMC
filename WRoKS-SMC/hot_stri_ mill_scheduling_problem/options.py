...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        description="训练学习驱动求解器的参数和超参数")

    # data
    parser.add_argument('--problem', default='HSMSP',
                        help="The problem to solve, default 'HSMSP', use 'HSMPS' if Supervised Learning")
    parser.add_argument('--min_size', type=int, default=25,
                        help="The job size of the problem graph")
    parser.add_argument('--machine', type=int, default=11,  #Multiple processes, parameters in 11 dimensions
    ...
    # Model/Encoded with graph neural networks
    parser.add_argument('--model', default='attention',
                        help="Model: 'attention'")
    parser.add_argument('--encoder', default='gat',
                        help="Graph encoder: 'gat'")
