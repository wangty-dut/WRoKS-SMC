...
from problems.HSMSP.problem_hsmsp import HSMSP


def load_problem(name):
    print(f"Loading problem: {name}")  # Print the loaded problem name
    problem = {
        'HSMSP': HSMSP,
    }.get(name, None)  # No need to convert case
...
def _load_model_file(load_path, model):
    """Load model with parameters from file, return optimizer state dict if present in file"""
